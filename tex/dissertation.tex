...
\rightline{\LARGE \textbf{Artjoms I\v{s}kovs}}
...
CTM training processs with prior enforcement was implemented and inference of the pathway distribution for a new document was designed and implemented. Multiple evaluation methods were designed and the model was tested on synthetic (toy) and real-world datasets.
...
%\hline
%$\theta$ of CTM & 0.163 & 0.032 \\
%$\theta$ of CTM-exp & 0.156 & 0.046 \\
%$\theta$ of LDA & 0.144 & 0.026 \\
%Random $\theta$ & 0.126 & 0.030 \\
%Raw gene expression data (not exponentiated) &  0.165 & 0.040 \\
%Raw gene expression data (exponentiated) & 0.176 & 0.034 \\
%\hline
%\end{tabu}
...
\begin{landscape}
	...
	\begin{figure}[!htb]
		\includegraphics[height=\textwidth]{pathway-tree.eps}
